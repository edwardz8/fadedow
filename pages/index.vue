...
useSeoMeta({
  title: 'FadeDow Sports Betting',
  ogTitle: 'FadeDow Sports Betting Blog',
  description: 'College Football Sports Bettor',
  ogDescription: 'College Football Sports Bettor',
